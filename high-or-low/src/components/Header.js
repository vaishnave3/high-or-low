            ...
            <div>
                <div className='imgs'>
                    <div className='leftimg'>
                        ...
                        <button onClick={handleButton1}>{img1.name1}</button>
                    </div>
                    <div className='score'>
                        <h1>Score : {score}</h1>
                        <button className="samebtn" onClick={handleButton3}>Both have the same rating!</button>
                    </div>
                    <div className='rightimg'>
                        <img src={img2.src2} alt={img2.name2} />
                        <button onClick={handleButton2}>{img2.name2}</button>
                    </div>
                </div>
            </div>
        )
